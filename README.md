# Les radars routiers en france<a name="1"></a>
...
3. [Origine et traitement des données](#3)
 <br/> A. [Jeu de données n°1 : Répartition des radars en France](#4)
 <br/> B. [Jeu de données n°2 :  les  les accidents corporels de la circulation routière (2010-2020)](#5)
...
## Origine et traitement des données  <a id="3"></a>
### A. Jeu de données n°1 : Répartition des radars en France <a id="4"></a> 
...
### B. Jeu de données n°2 :  les  les accidents corporels de la circulation routière (2011-2020) <a id="5"></a> 
...
## Visualaisation de la répartition des radars sur l'ensemble du teriitoir francais <a id="6"></a>
...
## Visualisation des differents types de radars <a name="7"></a>
...
## Visualisation des lieux d'accident les plus courant avec Wikidata Query Service <a id="10"></a>
